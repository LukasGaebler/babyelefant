...
class RCNN_only(nn.Module):
    ...
    def __init__(self):
        ...
        self.model = torch.jit.load('parameter_estimination.pt',map_location=self.device)
        ...
        self.eval_trnfs_maskrcnn = build_transforms_maskrcnn()
    ...
    def forward(
        ...
        list_of_oneLargeBbox_list_cpu = oneLargeBboxList([W_num], [
                                                                    H_num])
