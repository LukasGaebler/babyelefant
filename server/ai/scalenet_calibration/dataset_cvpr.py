...
# DS_ROOT = '/data/SUN360/crops_dataset_cvpr_myDistNarrowerLarge1105' #
# ECCV submission: SUNV1
...
if 'Narrower' in DS_ROOT:
    ...
    # print(
    #     colored(
    #         "[data-SUN360] Narrower in DS_ROOT:" +
    #         DS_ROOT,
    #         'white',
    #         'on_blue'))
    ...
    print(
        colored(
            "[data-SUN360] Wider20200403 in DS_ROOT:" +
            DS_ROOT,
            'white',
            'on_blue'))
...
class SUN360Horizon:
    def __init__(self, transforms=None, train=True, logger=None):
        ...
        self.logger.info('===== %d for the %s set...' %
    ...
    def __getitem__(self, k):
        ...
        im_path = self.data[k]
        im_ori_RGB = Image.open(im_path).convert(
...
def my_collate_SUN360(batch):
    ...
    im_path_list, im_list, y1_list, y2_list, y3_list, y4_list, data_list, pitch_list, roll_list, vfov_list, horizon_list, focal_length_35mm_eq_list, sensor_size_list, W_list, H_list, idx1_list, idx2_list, idx3_list, idx4_list = zip(
        *batch)
