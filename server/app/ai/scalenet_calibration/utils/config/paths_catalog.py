...
class DatasetCatalog(object):
    ...
    DATASETS = {
        ...
        "voc_2012_test": {
            "data_dir": "voc/VOC2012",
            "split": "test"
            # PASCAL VOC2012 doesn't made the test annotations available, so
            # there's no json annotation
        },
...
class ModelCatalog(object):
    ...
    def get_c2_detectron_12_2017_baselines(name):
        ...
        # we use as identifiers in the catalog
        # Caffe2Detectron/COCO/<model_id>/<model_name>
        prefix = ModelCatalog.S3_C2_DETECTRON_URL
